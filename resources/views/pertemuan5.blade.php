...
<head>
  ...
  <!-- =======================================================
  * Template Name: Arsha (Alwida Version)
...
<body class="index-page">
 <header id="header" class="header d-flex align-items-center fixed-top">
  ...
  <main class="main">
    ...
    </section><!-- /Header Section Alwida-->

       <!-- About Section Alwida-->
    <section id="about" class="about section">

     <!-- laptop Section Alwida -->
      ...
      <div class="container-fluid">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5 order-1 order-lg-2 why-us-img">
            <img src="assets/img/DELL.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>
        </div>

      </div>

    </section><!-- /Laptop Section Alwida -->
